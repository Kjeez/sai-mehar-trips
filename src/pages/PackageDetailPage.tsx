...
const PackageDetailPage = () => {
  ...
  const getRelevantImages = () => {
    ...
    const imageBank = [
      ...
      { keywords: ['sikkim', 'darjeeling', 'gangtok'], img: '/images/places/sikkim.png' },
      { keywords: ['kerala', 'munnar', 'cochin'], img: '/images/places/kerala.png' },
      ...
      { keywords: ['udaipur', 'mount abu'], img: '/images/places/udaipur.png' },
